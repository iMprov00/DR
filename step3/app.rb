...
BREWING_STEPS = [
  ...
  {
    instruction: "3. Добавь пломбир (он в морозилке), но не забудь освободить из вафельного стаканчика. Растопи всё до однородной массы",
    gif: "step3.gif"
  },
  {
    ...
    when Telegram::Bot::Types::Message
      ...
      when '/start'
        ...
        safe_send(bot, message.chat.id) do
          bot.api.send_message(
            chat_id: message.chat.id,
            text: "И как бы я не хотел, но Дамблдор приказал передать вам эту инструкцию... но тогда зачем мне вас проверять? Впрочем неважно, вы и с этим не справитесь..."
          )
        end
